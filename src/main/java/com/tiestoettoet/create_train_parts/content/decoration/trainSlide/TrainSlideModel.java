...
public class TrainSlideModel extends CTModel {
    protected static final ModelProperty<CullData> CULL_PROPERTY = new ModelProperty<>();
    public static TrainSlideModel standard(BakedModel originalModel) {
        return new TrainSlideModel(originalModel, AllSpriteShifts.ANDESITE_CASING);
    }
    public TrainSlideModel(BakedModel originalModel, CTSpriteShiftEntry shift) {
        super(originalModel, new EncasedCTBehaviour(shift));
    }
