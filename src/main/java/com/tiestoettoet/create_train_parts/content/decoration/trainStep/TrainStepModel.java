...
public class TrainStepModel extends CTModel {
    protected static final ModelProperty<CullData> CULL_PROPERTY = new ModelProperty<>();
    public static TrainStepModel standard(BakedModel originalModel) {
        return new TrainStepModel(originalModel, AllSpriteShifts.ANDESITE_CASING);
    }
    public TrainStepModel(BakedModel originalModel, CTSpriteShiftEntry shift) {
