package com.tiestoettoet.create_train_parts.foundation.sound;
...
public class SoundScapes {
    ...
    private static SoundScape crossing(float pitch, AmbienceGroup group) {
        return new SoundScape(pitch, group).continuous(AllSoundEvents.CROSSING_BELL.getMainEvent(), 2f, 1);
    }
