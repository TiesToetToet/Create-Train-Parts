...
public class AllSoundEvents {
    ...
    private static SoundEntryBuilder create(String name) {
        return create(CreateTrainParts.asResource(name));
    }
    ...
    public static class SoundEntryProvider implements DataProvider {
        ...
        public String getName() {
            return "Create Train Parts' Custom Sounds";
        }

        public CompletableFuture<?> generate(Path path, CachedOutput cache) {
            path = path.resolve("assets/create_train_parts");
    ...
    public static class SoundEntryBuilder {
        ...
        public SoundEntryBuilder addVariant(String name) {
            return addVariant(CreateTrainParts.asResource(name));
        }
        ...
        public SoundEntry build() {
            SoundEntry entry =
                    wrappedEvents.isEmpty() ? new AllSoundEvents.CustomSoundEntry(id, variants, subtitle, category, attenuationDistance)
                            : new AllSoundEvents.WrappedSoundEntry(id, subtitle, wrappedEvents, category, attenuationDistance);
